...
func _init(c_seed = null):
	...
	_bezier_points = [Vector2(0.0, 0.0), Vector2(0.1, 0.0), Vector2(-0.1, -0.1), Vector2(0.7, -0.3), Vector2(0.3, -0.6), Vector2(0.8, -0.7), Vector2(0.4, -1.0)]
	for point in range(_bezier_points.size()):
		_bezier_points[point] -= Vector2(0.0, _bezier_points[-1].y + 0.1)
